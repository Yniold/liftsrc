...
% Last Modified by GUIDE v2.5 10-Jul-2005 18:21:22
...
set(handles.txtMCP1onl,'String',[num2str(avgMCP1onl,3),' mW']);
set(handles.txtMCP1offl,'String',[num2str(avgMCP1offl,3),' mW']);
set(handles.txtMCP2onl,'String',[num2str(avgMCP2onl,3),' mW']);
set(handles.txtMCP2offl,'String',[num2str(avgMCP2offl,3),' mW']);
