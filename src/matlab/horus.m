...
if isfield(data,'hFlyDetection')
    if ishandle(data.hFlyDetection) 
        ...
        if P20(lastrow)<1 | P20(lastrow)>10 | DiodeWZ1in(lastrow)<2 | DiodeWZ1out(lastrow)<0.6*DiodeWZ1in ...
                | DiodeWZ2in(lastrow)<0.4 | DiodeWZ2out(lastrow)<0.6*DiodeWZ2in | MFCFlow(lastrow)<4 | MFCFlow(lastrow)>9 ...
