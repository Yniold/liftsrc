...
'P1000',918,'(0.44588*x-9996.6)*996/965','mbar';
'P1000SumDat',919,'(0.44588*x-9996.6)*996/965','mbar';
...
'DiodeWZ2out',936,'1.7905e-6.*x.^2+6.297e-3.*x','mW';
...
'DiodeWZ2in',891,'1e-6.*x.^2+0.0087.*x-0.09','mW';
