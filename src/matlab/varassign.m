...
'TDet',930,'1./(3.3540154E-3+2.5627725E-4.*log(22030./3000./(4.094.*1550./(x-9999)-1))+2.082921E-6.*(log(22030./3000./(4.094.*1550./(x-9999)-1))).^2+7.30003206E-8.*(log(22030./3000./(4.094.*1550./(x-9999)-1))).^3)-273.15','C';
