function varargout = Blue_SpectrometerGui(varargin)
% BLUE_SPECTROMETERGUI M-file for Blue_SpectrometerGui.fig
%      BLUE_SPECTROMETERGUI, by itself, creates a new BLUE_SPECTROMETERGUI or raises the existing
%      singleton*.
%
%      H = BLUE_SPECTROMETERGUI returns the handle to a new BLUE_SPECTROMETERGUI or the handle to
%      the existing singleton*.
%
%      BLUE_SPECTROMETERGUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in BLUE_SPECTROMETERGUI.M with the given input arguments.
%
%      BLUE_SPECTROMETERGUI('Property','Value',...) creates a new BLUE_SPECTROMETERGUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before SpectrometerGui_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to Blue_SpectrometerGui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help Blue_SpectrometerGui

% Last Modified by GUIDE v2.5 18-Jul-2008 10:18:32

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @Blue_SpectrometerGui_OpeningFcn, ...
                   'gui_OutputFcn',  @Blue_SpectrometerGui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before Blue_SpectrometerGui is made visible.
function Blue_SpectrometerGui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to Blue_SpectrometerGui (see VARARGIN)

% Choose default command line output for Blue_SpectrometerGui
...
specdata=ReadSpec('/gollum/ramdisk/status.spc');
...
function varargout = Blue_SpectrometerGui_OutputFcn(hObject, eventdata, handles) 
